# ==============================================================================
#  Fancord — Script d'injection Post-Installation
#  Utilisé par l'installateur Inno Setup pour injecter Fancord dans Discord.
# ==============================================================================
...
# On pointe vers le patcher.js dans le dossier d'installation de Fancord
$FancordPatcher = Join-Path $AppDir "dist\desktop\patcher.js"
$FancordPatcher = $FancordPatcher.Replace("\", "\\")
...
// Injection Fancord
try {
    require(\"$FancordPatcher\");
} catch (e) {
    console.error(\"Fancord injection failed:\", e);
