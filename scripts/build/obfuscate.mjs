// @ts-check
/*
 * Fancord — Post-build obfuscation
 * Applied to generated .js files BEFORE .asar packaging and electron-builder.
...
// ─── Fichiers ciblés ────────────────────────────────────────────────────────
// dist/js/   → buildDesktop (Fancord app itself)
...
// dist/desktop/ et dist/fancord/ → build.mjs (asar vencord)
const ASAR_JS_FILES = [
    "patcher.js",
    "preload.js",
    "renderer.js",
 ...
 * @param {string} dir  ex: "dist/desktop" ou "dist/fancord"
 */
