/*
 * Fancord, a desktop app aiming to give you a snappier Discord Experience
...
await Promise.all([
    ...
    createContext({
        ...NodeCommonOpts,
        entryPoints: ["src/fancord/main/index.ts"],
    ...
    createContext({
        ...NodeCommonOpts,
        entryPoints: ["src/fancord/preload/index.ts"],
        outfile: "dist/js/preload.js",
        footer: { js: "//# sourceURL=VesktopPreload" }
    }),
    createContext({
        ...NodeCommonOpts,
        entryPoints: ["src/fancord/preload/splash.ts"],
        outfile: "dist/js/splashPreload.js",
        footer: { js: "//# sourceURL=VesktopSplashPreload" }
    }),
    createContext({
        ...NodeCommonOpts,
        entryPoints: ["src/fancord/preload/updater.ts"],
    ...
    createContext({
        ...CommonOpts,
        globalName: "Equibop",
        entryPoints: ["src/fancord/renderer/index.ts"],
        outfile: "dist/js/renderer.js",
        format: "iife",
        inject: ["./scripts/build/injectReact.mjs"],
        jsxFactory: "VencordCreateElement",
        jsxFragment: "VencordFragment",
        external: ["@Fancord/types/*", "@fancord/types/*"],
        plugins: [vencordDep, includeDirPlugin("patches", "src/fancord/renderer/patches")],
...
if (watch) {
	...
	// Obfuscation post-build (disabled in dev mode)
	if (!isDev) {
