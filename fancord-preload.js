// Fancord preload — globalPaths fix + Equicord avec contextBridge
"use strict";
(function () {
    ...
    try {
        ...
        if (rendererJs) {
            webFrame.executeJavaScript(rendererJs).catch(e => {
                console.error("[Fancord] renderer inject failed:", e?.message);
            });
        }
    } catch (e) {
        console.error("[Fancord] VencordPreloadGetRendererJs failed:", e);
    }
