# ==============================================================================
#  Fancord — Désinstalleur utilisateur (PowerShell)
#  Supprime l'injection Fancord de Discord
#
...
$InstallDir    = Join-Path $env:LOCALAPPDATA "Fancord-Client"
...
Write-Host "  ║      FANCORD — Désinstalleur           ║" -ForegroundColor Cyan
Write-Host "  ╚══════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  │  Fancord désinstallé avec succès !                 │" -ForegroundColor Green
