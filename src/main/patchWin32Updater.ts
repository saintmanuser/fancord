...
function patchLatest() {
    try {
        ...
        console.info("[Fancord] Detected Host Update. Repatching...");
        ...
        writeFileSync(join(app, "index.js"), "// Fancord repatch\n\"use strict\";\nconst path = require(\"path\");\nrequire(path.join(__dirname, \"..\", \"app\", \"dist\", \"desktop\", \"patcher.js\"));");
    } catch (err) {
        console.error("[Fancord] Failed to repatch latest host update", err);
    }
}
