...
export default definePlugin({
    name: "UserAreaTweaks",
    description: "Creates an elegant floating dock for Fancord plugins using pure CSS, preventing overlap and crashes.",
    authors: [{ name: "Fancord", id: 0n }],
    enabledByDefault: true,

    start() {
        const style = document.createElement("style");
        style.id = "fancord-userarea-tweaks-style";
        style.textContent = CSS;
        document.head.appendChild(style);
    },

    stop() {
        document.getElementById("fancord-userarea-tweaks-style")?.remove();
    }
});
