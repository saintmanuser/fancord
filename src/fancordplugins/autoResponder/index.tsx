...
import { getGroqKey,groqChat } from "../fancordAI/groqManager";
            ...
            <div style={{
                ...
                <div>
                    ...
                    <div style={{ fontSize: "13px", marginTop: "4px" }}>
                        ...
                        Please configure it once in the <strong>FancordAI</strong> settings.
                    </div>
                </div>
            </div>
        )
        ...
        if (!apiKey) {
            try {
                ...
                openConfirmationModal({
                    ...
                    content: "AutoResponder requires a Groq API Key to function. Please configure it once in the FancordAI settings.",
                    confirmText: "Configure FancordAI",
                    cancelText: "Cancel",
                    onConfirm: () => {
                        const { openModal } = findByPropsLazy("openModal");
                        // Logique pour ouvrir les settings FancordAI si possible
                    }
                });
            } catch (e) {
