...
const REMOTE_VERSION_URL =
    "https://api.github.com/repos/fancordoff/fancord/releases/latest";
...
async function checkForUpdates() {
    try {
        ...
        console.log(`[FancordUpdater] local=${localVersion} remote=${remoteVersion}`);
        ...
        console.error("[FancordUpdater] Error vérification:", e);
    }
}
...
function UpdateBanner() {
    ...
    async function doUpdate() {
        ...
        try {
            ...
            setTimeout(() => {
                try {
                    VencordNative.fancord?.relaunch?.();
                } catch {
            ...
            console.error("[FancordUpdater] Error mise à jour:", e);
    ...
    return React.createElement("div", {
        ...
        React.createElement("div", {
            ...
            React.createElement("span", { style: { fontWeight: 700, flexShrink: 0 } },
                `🔔 Fancord ${info.remoteVersion} available!`
            ),
...
function mountBanner() {
    if (bannerContainer || document.getElementById("fancord-updater-root")) return;
    bannerContainer = document.createElement("div");
    bannerContainer.id = "fancord-updater-root";
    ...
    try {
        ...
        console.error("[FancordUpdater] Error montage bannière:", e);
    }
}
