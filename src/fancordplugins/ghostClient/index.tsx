...
const DS_KEY_TOKENS = "fancord-ghost-tokens";
const DS_KEY_AUTO_FOLLOW = "fancord-ghost-autofollow";
const DS_KEY_MIC_DEVICE = "fancord-ghost-mic-device-label";
const DS_KEY_SELECTED = "fancord-ghost-selected";
