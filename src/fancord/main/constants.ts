...
const FancordDir = dirname(process.execPath);

export const PORTABLE =
    process.platform === "win32" &&
    !process.execPath.toLowerCase().endsWith("electron.exe") &&
    !existsSync(join(FancordDir, "Uninstall Fancord.exe"));

export const DATA_DIR =
    process.env.Fancord_USER_DATA_DIR || (PORTABLE ? join(FancordDir, "Data") : join(app.getPath("userData")));
...
export const USER_AGENT = `Fancord/${app.getVersion()} (https://github.com/Fancord/Fancord)`;
