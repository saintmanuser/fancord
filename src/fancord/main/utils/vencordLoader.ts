...
export async function downloadVencordAsar() {
    await downloadFile(
        "https://github.com/Fancord/Fancord/releases/latest/download/Fancord.asar",
        VENCORD_DIR,
        {},
...
export function isValidVencordInstall(dir: string) {
    return existsSync(join(dir, "Fancord/main.js"));
}

export async function ensureVencordFiles() {
    if (!existsSync(VENCORD_DIR)) {
        console.error("Bundled fancord.asar not found at", VENCORD_DIR);
    }
}
