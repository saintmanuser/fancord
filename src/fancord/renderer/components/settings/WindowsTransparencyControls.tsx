...
import { Heading, Paragraph } from "@Fancord/types/components";
import { Margins } from "@Fancord/types/utils";
import { Select } from "@Fancord/types/webpack/common";
            ...
            <SimpleErrorBoundary>
                <Select
                    ...
                    options={[
                        ...
                        {
                            label: "Acrylic (blurs the window behind Fancord for a translucent background)",
                            value: "acrylic"
                        }
                    ]}
                    closeOnSelect={true}
