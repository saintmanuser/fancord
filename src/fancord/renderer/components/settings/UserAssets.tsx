...
import { BaseText, Button, FormSwitch } from "@Fancord/types/components";
import {
    Margins,
    ModalCloseButton,
    ModalContent,
...
import { showToast, useState } from "@Fancord/types/webpack/common";
        ...
        <section>
            ...
            <div className="vcd-user-assets-asset">
                <img
                    ...
                    src={`fancord://assets/${asset}?v=${version}`}
                    alt=""
