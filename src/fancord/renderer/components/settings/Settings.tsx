...
import { classNameFactory } from "@Fancord/types/api/Styles";
import { BaseText, Divider, ErrorBoundary } from "@Fancord/types/components";
...
const SettingsOptions: Record<string, Array<BooleanSetting | SettingsComponent>> = {
    ...
    "User Interface": [
        ...
        },
        {
            key: "staticTitle",
            title: "Static Title",
            description: 'Makes the window title "Fancord" instead of changing to the current page',
            defaultValue: false
        },
        {
            key: "enableMenu",
        ...
        },
        {
            ...
            description:
                "Shows a small splash screen while Fancord is loading. Disabling this option will show the main window earlier while it's still loading.",
            defaultValue: true
        },
        {
            key: "splashTheming",
    ...
    Behaviour: [
        {
            key: "tray",
            title: "Tray Icon",
            description: "Add a tray icon for Fancord",
            defaultValue: true,
            invisible: () => isMac
        },
        {
            ...
            description: "Hitting X will make Fancord minimize to the tray instead of closing",
            defaultValue: true,
            invisible: () => isMac,
        ...
        },
        {
            ...
            description: "Left clicking tray icon will toggle the Fancord window visibility.",
            defaultValue: false
        },
        {
            key: "disableMinSize",
    ...
    Miscellaneous: [
        ...
        },
        {
            ...
            description: "Opens links in a new Fancord window instead of your web browser",
            defaultValue: false
        }
    ],
...
export default ErrorBoundary.wrap(
    ...
    {
        message:
            "Failed to render the Fancord Settings tab. If this issue persists, try to right click the Fancord tray icon, then click 'Repair Fancord'. And make sure your Fancord is up to date."
    }
);
