...
import { Button, Card, HeadingTertiary, Paragraph } from "@Fancord/types/components";
import { useAwaiter } from "@Fancord/types/utils";
...
export function OutdatedVesktopWarning() {
    ...
    return (
        <Card variant="warning" className={cl("updater-card")}>
            <HeadingTertiary>Your Fancord is outdated!</HeadingTertiary>
