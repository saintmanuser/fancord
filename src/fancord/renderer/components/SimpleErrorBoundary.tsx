...
import { Card, ErrorBoundary, HeadingTertiary, Paragraph, TextButton } from "@Fancord/types/components";
import { FluxDispatcher, InviteActions } from "@Fancord/types/webpack/common";
...
function Fallback() {
    return (
        <Card variant="danger">
            ...
            <Paragraph>
                Please make sure Fancord and Fancord are fully up to date. You can get help in our{" "}
