...
import { FluxDispatcher, MediaEngineStore, Select, UserStore, useState } from "@Fancord/types/webpack/common";
...
const logger = new Logger("FancordScreenShare");
