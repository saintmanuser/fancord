...
import { Logger } from "@Fancord/types/utils";
import { findLazy, onceReady } from "@Fancord/types/webpack";
import {
    ...
    InviteActions,
    StreamerModeStore
} from "@Fancord/types/webpack/common";
import { IpcCommands } from "shared/IpcEvents";

import { onIpcCommand } from "./ipcCommands";

const logger = new Logger("FancordRPC", "#5865f2");
