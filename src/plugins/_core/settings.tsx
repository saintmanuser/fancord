...
import { CreateThemeTab } from "@fancordplugins/createTheme/components/CreateThemeTab";
import { PencilSparkleIcon } from "@fancordplugins/createTheme/components/PencilSparkleIcon";
import IconsTab from "@fancordplugins/iconViewer/components/IconsTab";
...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the Fancord settings section",
        options: [
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        const equicordSection: SettingsLayoutNode = {
            ...
            useTitle: () => {
                try { if (localStorage.getItem("Fancord_stealthMode") === "1") return ""; } catch { }
                return "Fancord Settings";
            },
            buildLayout: () => {
                try { if (localStorage.getItem("Fancord_stealthMode") === "1") return [mainEntry]; } catch { }
                return fullEntries;
            }
        };
    ...
    getInfoRows() {
        ...
        const rows = [`Fancord ${gitHashShort}${getVersionInfo()}`];
