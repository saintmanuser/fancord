...
let FancordBadges = {} as Record<string, Array<Record<"tooltip" | "badge", string>>>;
...
async function loadAllBadges(noCache = false) {
    const fancordBadges = await loadBadges("https://raw.githubusercontent.com/saintmanuser/fancord/master/merged_badges.json", noCache).catch(() => ({}));

    DonorBadges = {};
    EquicordDonorBadges = {};
    FancordBadges = fancordBadges;
}
...
export default definePlugin({
    ...
    getFancordBadges(userId: string) {
        try {
            const userBadges = FancordBadges[userId];
            ...
            for (const badge of userBadges) {
                ...
                results.push({
                    iconSrc: iconSrc,
                    description: (badge as any).tooltip || (badge as any).description || (badge as any).label || "Fancord Badge",
