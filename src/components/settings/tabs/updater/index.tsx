...
const REPO_URL = "https://github.com/fancordoff/fancord";
...
function UpdaterTab() {
    ...
    return (
        <SettingsTab>
            <Heading className={Margins.top16}>Fancord Updater</Heading>
            <Paragraph className={Margins.bottom20}>
                Check for new versions of Fancord. Updates can be installed automatically.
            </Paragraph>
            ...
            <Card style={{ padding: "12px 16px", marginBottom: 12 }}>
                <Flex style={{ alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <div>
                        ...
                        <div>
                            <Link href="https://fancord.online" style={{ fontSize: 13 }}>
                                fancord.online
                            </Link>
                        </div>
                    </div>
