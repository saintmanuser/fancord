...
import { ContributeModal } from "../../../../fancord/renderer/components/ContributeModal";
...
const DEV_TEAM = [
    {
        ...
        description: "Founder and owner of Fancord."
    },
    {
        id: "kza",
        name: "Kza",
        ...
        description: "Co-owner of Fancord."
    },
    {
        id: "attachante",
        name: "attachante",
        ...
        description: "Developer within the Fancord team."
    },
    {
        id: "Fancy",
        name: "Fancy",
    ...
    },
    {
        ...
        description: "Bot developer for Fancord."
    },
    {
        id: "biemal",
        name: "Biemal",
        ...
        description: "WebApp developer within the Fancord team."
    }
];
        ...
        <>
            <QuickActionCard>
                ...
                <QuickAction
                    Icon={PlanetIcon}
                    text="FanCord Server"
                    action={() => window.open("https://discord.gg/fancord", "_blank")}
                />
            </QuickActionCard>
...
function useStealthActive() {
    ...
    React.useEffect(() => {
        ...
        window.addEventListener("fancord-stealth-change", handler);
        return () => window.removeEventListener("fancord-stealth-change", handler);
    }, []);
    return active;
}
    ...
    return (
        <>
            ...
            <Paragraph className={Margins.bottom16}>
                {enabled
                    ? "Stealth mode is enabled — all Fancord visual elements are hidden. Shortcut: Ctrl+Shift+H"
                    : "Hides all Fancord visual elements (icons, buttons, context menus) without disabling plugins. Shortcut: Ctrl+Shift+H"}
            </Paragraph>
            <Button
    ...
    return (
        <SettingsTab>
            ...
            {!stealthActive && (<>
                ...
                <Paragraph className={Margins.bottom16}>
                    Configure how Fancord behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.
                </Paragraph>
                ...
                <Paragraph className={Margins.bottom16}>
                    Configure how Fancord handles notifications. You can customize when and how you receive alerts, or view a history of past notifications.
                </Paragraph>
            ...
            <Heading className={Margins.top20}>Stealth Mode</Heading>
            <Paragraph className={Margins.bottom16}>
                Hides all Fancord visual elements without disabling plugins. Shortcut: Ctrl+Shift+H
            </Paragraph>
            <StealthModeButton />
...
export default wrapTab(EquicordSettings, "Fancord Settings");
