...
export const enum IpcEvents {
    ...
    SET_WINDOW_BACKGROUND_MATERIAL = "FancordSetWindowBackgroundMaterial",
    ...
    // Fancord Updater — télécharge un exe depuis une URL et le lance
    FANCORD_DOWNLOAD_AND_RUN = "FancordDownloadAndRun",

    // VB-Audio Virtual Cable (Windows only)
    CHECK_VB_CABLE = "FancordCheckVBCable",
    INSTALL_VB_CABLE = "FancordInstallVBCable",

    // Relaunch de l'app Electron
    RELAUNCH_APP = "FancordRelaunchApp",
